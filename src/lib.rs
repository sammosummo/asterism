...
fn _core(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_function(pyo3::wrap_pyfunction!(gxs::python::gxs_fit, module)?)?;
    module.add_function(pyo3::wrap_pyfunction!(gxs::python::gxs_test, module)?)?;
