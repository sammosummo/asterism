...
| `RepeatedModel` | Public but outside 0.1 scientific support | One trait at many positions on a line, measured more than once. Joint repeated-audiogram decomposition is deferred; the univariate censored model answers the heritability question for 0.1. |
