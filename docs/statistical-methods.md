...
simulated null. The optional bootstrap target supplies exactly that null and
now passes at that exact design: all 800 requested attempts were measured and
the level held at both censoring shares. It remains experimental, because
passing at one design is not general qualification. None of this creates a
